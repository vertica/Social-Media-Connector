...
* HP Vertica Version 7.0.x - For platform requirements see: [Platform Requirements for 7.0.x](https://my.vertica.com/docs/7.0.x/HTML/index.htm#Authoring/SupportedPlatforms/SupportedPlatforms.htm)
